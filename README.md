...
- every released task carries the exact Question Brain release ID. The
  ...
  [`releases/task-release-2026-08-28-qb-d00a1493-g17.json`](releases/task-release-2026-08-28-qb-d00a1493-g17.json):
...
`/opt/releases/task-release-2026-08-28-qb-d00a1493-g17.json`, whose
